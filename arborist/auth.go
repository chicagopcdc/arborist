...
func authMapping(db *sqlx.DB, username string, server *Server) (AuthMapping, *ErrorResponse) {
	...
	stmt := `
		...
		where ltree2text(resource.path) not like all (ARRAY['programs.pcdc.projects.20220201.%', 'programs.pcdc.projects.20220808.%', 'programs.pcdc.projects.20220110.%', 'programs.pcdc.projects.20220501_S01.%', 'programs.pcdc.projects.20211006.%', 'programs.pcdc.projects.20210915.%', 'programs.pcdc.projects.20210212.%']);
	`
